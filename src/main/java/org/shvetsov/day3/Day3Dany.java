...
public class Day3Dany {
    ...
    public static final String INPUT_NAME = "input 3-1, 3-2.txt";
    ...
    public static int part1(String[] input) {
        ...
        if (!number.isEmpty())
            numbersOnLine.add(new Triple(firstLine.length - number.length(), firstLine.length - 1, Integer.parseInt(number.toString())));
        ...
        for (int i = 1; i < input.length - 1; i++) {
            ...
            if (!number.isEmpty())
                numbersOnLine.add(new Triple(charArray.length - number.length(), charArray.length - 1, Integer.parseInt(number.toString())));
            for (int j = 0; j < numbersOnLine.size(); j++) {
                Triple triple = numbersOnLine.get(j);
                boolean isValid = false;
                boolean isNotInTheBeginning = triple.fromIndex() > 0;
        ...
        if (!number.isEmpty())
            numbersOnLine.add(new Triple(lastLine.length - number.length(), lastLine.length - 1, Integer.parseInt(number.toString())));
    ...
    public static int part2(String[] input) {
        ...
        if (!number.isEmpty())
            numbersOnLine.add(new Quad(0, firstLine.length - number.length(), firstLine.length - 1, Integer.parseInt(number.toString())));
        ...
        for (int i = 1; i < input.length - 1; i++) {
            ...
            if (!number.isEmpty())
                numbersOnLine.add(new Quad(i, charArray.length - number.length(), charArray.length - 1, Integer.parseInt(number.toString())));
            for (int j = 0; j < numbersOnLine.size(); j++) {
                Quad quad = numbersOnLine.get(j);
                boolean isValid = false;
                boolean isNotInTheBeginning = quad.fromIndex() > 0;
        ...
        if (!number.isEmpty())
            numbersOnLine.add(new Quad(input.length - 1, lastLine.length - number.length(), lastLine.length - 1, Integer.parseInt(number.toString())));
